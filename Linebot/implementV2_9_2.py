...
BreakList = {}
errorText = "*An Error in implementV2_9_1"
...
class Bot():
    ...
    def select_group_list(self, event, user_id):
        try:
            database_class_list = self.db.getClassCodeList(34)
            database_class_name_list = self.db.getClassNameList(34)
